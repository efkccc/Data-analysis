...
AUC <- merge(confdet_acc, auc_detection)
AUC$auc <- as.numeric(AUC$auc)
auc_det <- AUC$'auc'
names(auc_det) <-AUC$response
...
BOLD_dis_mean <- aggregate(Data_Dis[, 16:21], list(Data_Dis$confidence, Data_Dis$response ), mean)
...
BOLD_til_mean <- aggregate(Data_Til[, 16:21], list(Data_Til$confidence, Data_Til$response ), mean)
...
rTPJ_dis <- ggplot(data=BOLD_dis_mean, aes(x=confidence, y=BOLD_rTPJ)) +
  geom_line(aes(colour = factor(response))) +
  geom_point(aes(color = factor(response)), size = 3) + 
  scale_color_manual(values=c("#984ea3", "#4daf4a")) +
...
rTPJ_til <- ggplot(data=BOLD_til_mean, aes(x=confidence, y=BOLD_rTPJ)) +
  geom_line(aes(colour = factor(response))) +
  geom_point(aes(color = factor(response)), size = 3) + 
  scale_color_manual(values=c("#ff7f00","#ffff33")) +
...
# Plotting vmPFC 
#################################### 
vmPFC_det <- ggplot(data=BOLD_det_mean, aes(x=confidence, y=BOLD_vmPFC)) +
  geom_line(aes(colour = factor(response))) +
  geom_point(aes(color = factor(response)), size = 3) + 
  scale_color_manual(values=c("#e41a1c", "#377eb8")) +
  labs(title="vmPFC detection 2", x= "confidence", y="mean activation", color="Response") +
  theme_classic() + scale_x_continuous(limits = c(0.5, 6),breaks=number_ticks(6)) + scale_y_continuous(limits = c(-1.5, 0), breaks=number_ticks(6))+
  theme(legend.position=c(0.8, 0.15),  
                 legend.background = element_blank(),
                 legend.key = element_blank(),
        legend.title = (element_text(size = 8)),
...
vmPFC_dis <- ggplot(data=BOLD_dis_mean, aes(x=confidence, y=BOLD_vmPFC)) +
  geom_line(aes(colour = factor(response))) +
  geom_point(aes(color = factor(response)), size = 3) + 
  scale_color_manual(values=c("#984ea3", "#4daf4a")) +
  labs(title="vmPFC detection 2", x= "confidence", y="mean activation", color="Response") +
...
vmPFC_til <- ggplot(data=BOLD_til_mean, aes(x=confidence, y=BOLD_vmPFC)) +
  geom_line(aes(colour = factor(response))) +
  geom_point(aes(color = factor(response)), size = 3) + 
  scale_color_manual(values=c("#ff7f00","#ffff33")) +
  labs(title="vmPFC detection 2", x= "confidence", y="mean activation", color="Response") +
...
# Plotting pMFC
#################################### 
pMFC_det <- ggplot(data=BOLD_det_mean, aes(x=confidence, y=BOLD_pMFC)) +
  geom_line(aes(colour = factor(response))) +
  geom_point(aes(color = factor(response)), size = 3) + 
  scale_color_manual(values=c("#e41a1c", "#377eb8")) +
  labs(title="pMFC detection ", x= "confidence", y="mean activation", color="Response") +
  theme_classic() + scale_x_continuous(limits = c(0.5, 6),breaks=number_ticks(6)) + scale_y_continuous(limits = c(0, 1.5), breaks=number_ticks(6))+
  theme(legend.position=c(0.8, 0.15),  
                 legend.background = element_blank(),
                 legend.key = element_blank(),
        legend.title = (element_text(size = 8)),
...
pMFC_dis <- ggplot(data=BOLD_dis_mean, aes(x=confidence, y=BOLD_pMFC)) +
  geom_line(aes(colour = factor(response))) +
  geom_point(aes(color = factor(response)), size = 3) + 
  scale_color_manual(values=c("#984ea3", "#4daf4a")) +
...
pMFC_til <- ggplot(data=BOLD_til_mean, aes(x=confidence, y=BOLD_pMFC)) +
  geom_line(aes(colour = factor(response))) +
  geom_point(aes(color = factor(response)), size = 3) + 
  scale_color_manual(values=c("#ff7f00","#ffff33")) +
...
# Plotting FPl
#################################### 
FPl_det <- ggplot(data=BOLD_det_mean, aes(x=confidence, y=BOLD_FPl)) +
  geom_line(aes(colour = factor(response))) +
  geom_point(aes(color = factor(response)), size = 3) + 
  scale_color_manual(values=c("#e41a1c", "#377eb8")) +
...
FPl_dis <- ggplot(data=BOLD_dis_mean, aes(x=confidence, y=BOLD_FPl)) +
  geom_line(aes(colour = factor(response))) +
  geom_point(aes(color = factor(response)), size = 3) + 
  scale_color_manual(values=c("#984ea3", "#4daf4a")) +
...
FPl_til <- ggplot(data=BOLD_til_mean, aes(x=confidence, y=BOLD_FPl)) +
  geom_line(aes(colour = factor(response))) +
  geom_point(aes(color = factor(response)), size = 3) + 
  scale_color_manual(values=c("#ff7f00","#ffff33")) +
...
# Plotting FPm
#################################### 
FPm_det <- ggplot(data=BOLD_det_mean, aes(x=confidence, y=BOLD_FPm)) +
  geom_line(aes(colour = factor(response))) +
  geom_point(aes(color = factor(response)), size = 3) + 
  scale_color_manual(values=c("#e41a1c", "#377eb8")) +
  labs(title="FPm detection ", x= "confidence", y="mean activation", color="Response") +
  theme_classic() + scale_x_continuous(limits = c(0.5, 6),breaks=number_ticks(6)) + scale_y_continuous(limits = c(-2, 0), breaks=number_ticks(6))+
  theme(legend.position=c(0.8, 0.15),  
                 legend.background = element_blank(),
                 legend.key = element_blank(),
        legend.title = (element_text(size = 8)),
...
FPm_dis <- ggplot(data=BOLD_dis_mean, aes(x=confidence, y=BOLD_FPm)) +
  geom_line(aes(colour = factor(response))) +
  geom_point(aes(color = factor(response)), size = 3) + 
  scale_color_manual(values=c("#984ea3", "#4daf4a")) +
...
FPm_til <- ggplot(data=BOLD_til_mean, aes(x=confidence, y=BOLD_FPm)) +
  geom_line(aes(colour = factor(response))) +
  geom_point(aes(color = factor(response)), size = 3) + 
  scale_color_manual(values=c("#ff7f00","#ffff33")) +
