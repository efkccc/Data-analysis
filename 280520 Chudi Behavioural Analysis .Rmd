...
```{r echo=FALSE, results = FALSE, message=FALSE, warning=FALSE, fig.width=3.5, fig.height=3.5}
# Neural data preparation detection
...
BOLD_det$response[BOLD_det$response=="0"] <- "No"
BOLD_det$response[BOLD_det$response=="1"] <- "Yes"
...
# Neural data preparation discrimination
...
BOLD_dis$response[BOLD_dis$response=="0"] <- "Anticlockwise"
BOLD_dis$response[BOLD_dis$response=="1"] <- "Clockwise"
...
BOLD_til$response[BOLD_til$response=="0"] <- "Vertical"
BOLD_til$response[BOLD_til$response=="1"] <- "Tilted"
...
#################################### 
rTPJ_det <- ggplot(data=BOLD_det, aes(x=confidence, y=rTPJ)) +
  geom_line(aes(colour = factor(response))) +
