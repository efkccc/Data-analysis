...
t1 <- t.test(confidence~response, mu=0, alt="two.sided", conf=0.95, data = dis)$statistic
p3 <- t.test(confidence~response, mu=0, alt="two.sided", conf=0.95, data = til)$p.value
t3 <- t.test(confidence~response, mu=0, alt="two.sided", conf=0.95, data = dis)$statistic
```
